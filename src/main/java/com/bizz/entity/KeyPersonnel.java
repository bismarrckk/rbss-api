...
public class KeyPersonnel {
	...
	@JsonBackReference(value="entity-personnel")
	@ManyToOne(fetch=FetchType.EAGER)
	@JoinColumn(name="entity_id")
	private Entities entity;
	@OneToOne(cascade = CascadeType.ALL)
    @JoinColumn(name = "personnel_type_id", referencedColumnName = "personnelTypeId")
	...
	public KeyPersonnel(int personnel_id, String firstName, String middleName, String lastName, long idNumber,
			String citizenType, String email, String phoneNumber, String officeNumber, String country, String state,
			String location, String zipcode, String address, String physicalAddress, Entities entity,
			KeyPersonnelType keyPersonnelType, int shares, String certification) {
		super();
