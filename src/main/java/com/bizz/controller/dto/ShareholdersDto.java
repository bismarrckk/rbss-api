...
public class ShareholdersDto {
	...
	public ShareholdersDto() {
		super();
	}

	public ShareholdersDto(int shareholder_id, String firstName, String middleName, String lastName, String category,
			long idNumber, String citizenType, String email, String phoneNumber, String officeNumber, String country,
			String state, String location, String zipcode, String address, String address2, boolean isDirector,
			Entities entity, List<Shares> shares) {
		super();
